...
class RecruitModal(ui.Modal):
    def __init__(self, bot, cog, title="", requirements=""):
        ...
        self.bot = bot
        self.cog = cog
        self.team_name = ui.TextInput(label="Team Name (also the post title)", style=TextInputStyle.short, placeholder="Your team's name", default_value=title, required=True, min_length=1, max_length=45)
